...
For a third party intergation to count as a Rehive extension it needs to adhere to a list of requirements set out by the Rehive team. These are detailed in the **Requirements** section.
...
1. Admin API endpoints, which admins (authenticated against the platform) can use to add and manage notifications that should be triggered by certin events in the platform.
