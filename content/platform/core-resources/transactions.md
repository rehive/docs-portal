...
Take a look at the [Platform API Reference](REPLACE) for the list of transaction endpoints.

Take a look at the [Platform Admin API Reference](REPLACE) for the list of transaction management endpoints.
