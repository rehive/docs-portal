...
6. Your custom extension patches the pending platform transaction with the outcome, `failed` or `complete` using the <code>[/admin/transactions/{tx_code}/](https://api.rehive.com/?api=rehive-platform-admin-api#tag/transactions/PATCH/3/admin/transactions/{tx_code}/)</code> endpoint.
