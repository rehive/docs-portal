...
3. User -> Documents
    ...
    3. Endpoint: `PATCH` on <code>[/admin/users/documents/{id}/](https://api.rehive.com/?api=rehive-platform-admin-api#tag/users/PATCH/3/admin/users/documents/{id}/)</code> with data `{“status”: “verified”}`
